...
$string['block_panopto_check_server_interval'] = 'Check server health interval';
$string['block_panopto_check_server_interval_desc'] = 'How often the actual Check server health is going to be executed. Status between intervals will be taken from the cache.';
