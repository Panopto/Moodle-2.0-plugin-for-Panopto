...
$string['block_panopto_admin_only_videolist'] = 'Admin-only completed recordings';
$string['block_panopto_admin_only_videolist_desc'] = 'In Panopto block, make the "Completed recordings" list available to administrators only';
