...
/**
 * Panopto block instance configuration form.
 *
...
class block_panopto_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        if ($panopto_data->is_provisioned()) {
            ...
            $provision_url = html_writer::link(new moodle_url('/blocks/panopto/provision_course_internal.php',
                    array('id' => $COURSE->id, 'return_url' => $_SERVER['REQUEST_URI'])),
                    get_string('add_to_panopto', 'block_panopto'));

            $or = get_string('or', 'block_panopto');
            $mform->addElement('html', $provision_url . "<br><br>-- $or --<br><br>");
